...
class _SlicesState extends State<Slices>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarClass().appBar(context, _scaffoldKeyProfile,false,count,title: "الذبائح"),
                ...
                return InkWell(
                  onTap: (){
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context)=>Zbaeh(snapShot.data[index][DataBaseConstants.PRODUCT_TABLE_ID])));
                  },
                  child: Material(
                    elevation: 5,
                    child: Container(
                                    ...
                                    children: <Widget>[
                                      Positioned(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          Image(image: AssetImage(snapShot.data[index][DataBaseConstants.PRODUCT_TABLE_IMAGE]),fit: BoxFit.fill,),
                                          ),
                                        ),
                                      ),
                                      Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Flexible(
                                        flex: 1,
                                        child: Text(snapShot.data[index][DataBaseConstants.PRODUCT_TABLE_NAME],
                                          style: TextStyle(
                                      ...
                                      Flexible(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(" ${snapShot.data[index][DataBaseConstants.PRODUCT_TABLE_PRICE]} ",
                                              style: TextStyle(
                                                  fontSize: 16,color: GoodColors.brown
                                              ),
                                            ),
