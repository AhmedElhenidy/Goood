  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FancyBottomNavigation(
          tabs: [
            TabData(iconData:Icons.person ,title: "حسابى" ),
            TabData(iconData: Icons.home, title: "الرئيسية"),
            TabData(iconData: Icons.favorite_border, title: "المفضلة")
          ],
        initialSelection: widget.initial,
        onTabChangedListener: navigationTapped,
        activeIconColor:GoodColors.greyLight ,
        textColor: GoodColors.grey,
